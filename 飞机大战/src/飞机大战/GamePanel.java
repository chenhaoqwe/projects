...
public class GamePanel extends JPanel implements MouseMotionListener, MouseListener {
    ...
    public GamePanel() {
        ...
        bx = 0;
        by = -5350;
        bg = new ImageIcon("E:\\游戏图片\\6.png").getImage();
    ...
    public void paint(Graphics g) {
        ...
        if(state==RUNNING){
            ...
            Image hero = new ImageIcon("E:\\游戏图片\\1.png").getImage(); 
            g.drawImage(hero, x - 50, y - 80, null);  //画出英雄机

            if (db) { //在敌机爆炸时画出爆炸图片
                Image boom = new ImageIcon("D:\\游戏\\2.png").getImage();
            ...
            Image start=new ImageIcon("D:\\游戏\\6.png").getImage();
            g.drawImage(start, 0, 0, 400, 650, null);
        }else if(state==OVER){ //结束界面
            Image over=new ImageIcon("D:\\游戏\\5.png").getImage();
            g.drawImage(over, 0, 0, 400, 650, null);
        }else if(state==PAUSE){ //暂停界面
            Image pause=new ImageIcon("D:\\游戏\\4.png").getImage();
            ...
            public void run() {
                ...
                while (true) {
                    if(state==RUNNING){
                        ...
                        if (by > 0) {
                            by = -5350;
                            bg = new ImageIcon("D:\\游戏\\6.png").getImage();
                        }
                        ...
                        // 创建敌机
                        if (count % 21 == 0) {
                            dj.add(new Dj("D:\\游戏\\3.png"));
                        }else if (count % 31 == 0) {
                            dj.add(new Dj("D:\\游戏\\3.png"));
                        }else if (count % 41 == 0) {
                            dj.add(new Dj("D:\\游戏\\1.png"));
                        }
